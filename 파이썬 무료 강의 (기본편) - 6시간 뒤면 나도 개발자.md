...
# __init__ : 파이썬에서 쓰이는 생성자(마린, 탱크 만들때 자동으로 호출되는 부분)
# marine1, marine2, tank 는 객체라고 한다.
# 마린과 탱크는 유닛클래스의 인스턴스라고 말한다.
# self를 제외한 개수만큼 똑같이 보내줘야 객체를 만들수 있다.(파라미터 개수)
```
...
![image-20201208210041292](C:\Users\3kist_000\AppData\Roaming\Typora\typora-user-images\image-20201208210041292.png)
...
![image-20201208222702375](C:\Users\3kist_000\AppData\Roaming\Typora\typora-user-images\image-20201208222702375.png)
...
![image-20201210215823973](C:\Users\3kist_000\AppData\Roaming\Typora\typora-user-images\image-20201210215823973.png)
...
![image-20201213105539313](C:\Users\3kist_000\AppData\Roaming\Typora\typora-user-images\image-20201213105539313.png)
...
C:\Users\3kist_000\AppData\Local\Programs\Python\Python39\lib\random.py
